...
#revisions to trait assignments
#change attached/fixed back to "other (specify in  comments)"
#no strong preference for thermal prefernce- examine assignments for those taxa
biotraits7.4$Thermal_pref[which(biotraits7.4$Thermal_pref=="No strong preference")]<-"Cool-warm eurythermal (5-30 C)"
str(biotraits7.4)
unique(biotraits7.4$Thermal_pref)
biotraits7.4$Habit_prim[which(biotraits7.4$Habit_prim=="Attached/fixed")]<-NA

write.csv(biotraits7.4,"~/Documents/WaterCube/Ch.3/aquatic_insects/biotraits_wide2.csv")
