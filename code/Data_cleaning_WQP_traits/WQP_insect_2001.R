...
insects3<-read.csv("insects2001v3.csv")
...
write.csv(biotraits3, "biotraits3.csv") #writing csv file for Ethan to work from
...
#subset insects database to only taxa not found in biotraits database
biotraits6<-insects4%>%
...
biotraits8<-biotraits6%>%
  full_join(biotraits7)%>%
